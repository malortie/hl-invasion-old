...
void Game_HookEvents( void )
{
	...
	gEngfuncs.pfnHookEvent( "events/supergun3.sc",				EV_FireSG3 );
	gEngfuncs.pfnHookEvent( "events/lflammes.sc",				EV_LFlammes );
	gEngfuncs.pfnHookEvent( "events/rpgidle.sc",				EV_RpgIdle );
	gEngfuncs.pfnHookEvent( "events/rpgreload.sc",				EV_RpgReload );
#endif // defined ( HLINVASION_CLIENT_DLL )
}
