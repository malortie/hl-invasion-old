...
//		pCurrent->m_flPumpTime			= pfrom->m_flPumpTime;
	...
	if ( player.m_pActiveItem->m_iId == WEAPON_RPG )
	{
		...
		pRPG->m_iAmmoType = (int)from->client.vuser2[1];
		switch (pRPG->m_iAmmoType)
		{
		case 0: pRPG->m_iAmmoRocket = (int)from->client.vuser2[2]; break;
		case 1: pRPG->m_iAmmoElectro = (int)from->client.vuser2[2]; break;
		case 2: pRPG->m_iAmmoNuclear = (int)from->client.vuser2[2]; break;
		default: break;
		}
#else
	...
	{
		player.ammo_fsniper = (int)from->client.vuser2[1];
	}
	else if (player.m_pActiveItem->m_iId == WEAPON_LFLAMMES)
	{
		player.ammo_oeufs = (int)from->client.vuser2[1];
	}
	else if(player.m_pActiveItem->m_iId == WEAPON_IRGUN)
	{
		player.ammo_irgun = (int)from->client.vuser2[1];
	}
	else if (player.m_pActiveItem->m_iId == WEAPON_M16)
	{
		player.ammo_m16 = (int)from->client.vuser2[1];
	}
	else if (player.m_pActiveItem->m_iId == WEAPON_SUPERGUN)
	{
		player.ammo_chewinggum = (int)from->client.vuser2[1];
	}
#endif // defined ( HLINVASION_CLIENT_DLL )
...
#if defined ( HLINVASION_CLIENT_DLL )
		CRpg* pRPG = (CRpg *)player.m_pActiveItem;
		from->client.vuser2[1] = pRPG->m_iAmmoType;
		switch ((int)from->client.vuser2[1])
		{
		case 0: from->client.vuser2[2] = pRPG->m_iAmmoRocket; break;
		case 1: from->client.vuser2[2] = pRPG->m_iAmmoElectro; break;
		case 2: from->client.vuser2[2] = pRPG->m_iAmmoNuclear; break;
		default: break;
		}
#else
	...
	{
		from->client.vuser2[1] = player.ammo_fsniper;
	}
	else if (player.m_pActiveItem->m_iId == WEAPON_LFLAMMES)
	{
		from->client.vuser2[1] = player.ammo_oeufs;
	}
	else if (player.m_pActiveItem->m_iId == WEAPON_IRGUN)
	{
		from->client.vuser2[1] = player.ammo_irgun;
	}
	else if (player.m_pActiveItem->m_iId == WEAPON_M16)
	{
		from->client.vuser2[1] = player.ammo_m16;
	}
	else if (player.m_pActiveItem->m_iId == WEAPON_SUPERGUN)
	{
		from->client.vuser2[1] = player.ammo_chewinggum;
	}
#endif // defined ( HLINVASION_CLIENT_DLL )
