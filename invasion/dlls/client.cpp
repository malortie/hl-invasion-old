			...
			if ( pl->m_pActiveItem )
			{
				...
				if ( gun && gun->UseDecrement() )
				{
					...
					if ( pl->m_pActiveItem->m_iId == WEAPON_RPG )
					{
						...
						switch ((int)cd->vuser2.y)
						{
						case 0: cd->vuser2.z = pRPG->m_iAmmoRocket; break;
						case 1: cd->vuser2.z = pRPG->m_iAmmoElectro; break;
						case 2: cd->vuser2.z = pRPG->m_iAmmoNuclear; break;
						default: break;
						}
#else
